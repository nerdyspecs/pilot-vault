...
| **F6 · Customers, vehicles & jobsheet** | The records intakes attach to, plus the digitized intake form | 6 | Customers, Customer show, Vehicle show, *(jobsheet)* | customer/vehicle built; **jobsheet not built** (models + forms + field-admin — S5, next) |
